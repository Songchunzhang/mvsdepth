...
from mvsdepth.layers import SSIM, BackprojectDepth, Project3D, transformation_from_parameters, \
    disp_to_depth, get_smooth_loss, compute_depth_errors

from mvsdepth import datasets, networks
...
class Trainer:
    def __init__(self, options):
        ...
        for key in self.models.keys():
            self.models[key] = DDP(self.models[key], device_ids=[self.opt.local_rank], output_device=self.opt.local_rank, 
        ...
        self.train_loader = DataLoader(
            ...
            worker_init_fn=seed_worker, sampler=train_sampler)
    ...
    def run_epoch(self):
        ...
        for batch_idx, inputs in enumerate(self.train_loader):
            ...
            loss = reduce_tensor(losses["loss"], self.world_size)
            loss.backward()
